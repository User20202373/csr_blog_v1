...
public class UserController {
    ...
    // @AuthenticationPrincipal은 Security Session 에서
    // Authentication 객체를 꺼내서 사용할 수 있도록 하는 어노테이션
    @GetMapping("/{userId}")
    ...
    public ResponseEntity<?> updateUser(@AuthenticationPrincipal User sessionUser,
                                        @Valid @RequestBody UserRequest.UpdateDTO requestDTO, Error errors) {
